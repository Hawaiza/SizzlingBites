...
public class Add_Users extends AppCompatActivity {
    ...
    public void sendSMS(String phone, String pswd, String emailid) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {
                ...
                smsManager.sendTextMessage(phone, null, "Your Sizzling bytes Email-Id/Username: \n" +emailid +" Password: \n" +pswd+ "\nDo not share this with anyone.", null, null);
                Toast t = Toast.makeText(getApplicationContext(), "An SMS has been sent to your Mobile No.", Toast.LENGTH_LONG);
                t.show();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        designation=(EditText) findViewById(R.id.addAddress);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sv = new Intent(Add_Users.this,LoginsignupActivity.class);
                startActivity(sv);
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.getText().toString().isEmpty() && password.getText().toString().isEmpty() && mobile.getText().toString().isEmpty() && name.getText().toString().isEmpty() && designation.getText().toString().isEmpty() ) {
                    ...
                    Toast.makeText(Add_Users.this, "Please enter Address", Toast.LENGTH_SHORT).show();
                }
                    ...
                    if (cursor.getCount() > 0) {
                        ...
                        if (res.getCount() > 0) {
                            ...
                            Intent intent = new Intent(Add_Users.this, MainActivity.class);
